...
function ListarArticulosAprobados(){
    ...
    var request = new Request('https://localhost:44395/api/Articulo/'+ced+'/'+ced+'/'+ced+'/'+offset, {
        method: 'Get',
    });
...
function ListarArticulosParaPublicar(){
    ...
    .then(function(data) {
        ...
        for (var articulos in json) {
            ...
            small_select.setAttribute("onchange","ActualizarData("+json[articulos].id_art+")");
...
function ListarMensajes(){
    ...
    var request = new Request('https://localhost:44395/api/Mensaje/'+ced+'/'+offset, {
        method: 'Get',
    });
...
function ListarArticulos(){
    limpiar();
    var ced = localStorage.getItem("ced");
    var request = new Request('https://localhost:44395/api/Articulo/'+ced+'/'+offset, {
        method: 'Get',
    });
...
function ConsultarArticulo(){
    ...
    var request = new Request('https://localhost:44395/api/Articulo/'+ced+"/"+id_articulo+"/"+title, {
        method: 'Get',
    });
